...
public class PoCNfcEngine extends NfcEngine {
    ...
    public Response writeWifiAccessTagResponse(String systemValue, Tag tag, boolean readOnly){
        NdefMessage nfcMessage = formatToNdefMessage(WIFI_PROVISIONNING, systemValue, false, null);
